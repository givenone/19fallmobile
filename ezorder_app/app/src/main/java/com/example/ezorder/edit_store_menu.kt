 ...
 * [edit_store_menu.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [edit_store_menu.newInstance] factory method to
 * create an instance of this fragment.
 */
class edit_store_menu : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment edit_store_menu.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            edit_store_menu().apply {
