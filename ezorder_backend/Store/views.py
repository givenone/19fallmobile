...
class StoreList(APIView):
    ...
    def store_search(self, latitude, longitude):
        ...
        stores_nearby = StoreProfile.objects.filter(latitude__lt=my_location[0] + 0.3,
                                                    latitude__gt=my_location[0] - 0.3,
                                                    longitude__lt=my_location[1] + 0.3,
                                                    longitude__gt=my_location[1] - 0.3)
